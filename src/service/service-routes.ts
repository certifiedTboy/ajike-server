...
import { ServiceControllers } from "./service-controllers.ts";
...
export class ServiceRoutes extends AppRoutesHandler {
  ...
  private featureRoutes() {
    this.routes.post(
      ...
      this.getCreateServiceValidationRules(),
    ...
    this.routes.get(
      "/admin",
      this.adminGuard,
      ServiceControllers.getAllServicesByAdmin,
    );
    ...
    this.routes.post(
      "/:serviceId/feedback",
      this.authGuard,
      this.getFeedbackValidationRules(),
      this.checkValidationResult,
    ...
    this.routes.put(
      ...
      this.authGuard,
      AppHelpers.sanitizeBody,
      this.getUpdateServiceValidationRules(),
      this.checkValidationResult,
   ...
   */
  private getCreateServiceValidationRules() {
    return [
      body("title")
        .trim()
        .isString()
   ...
   * @returns {Array} An array of express-validator middleware.
   */
  private getUpdateServiceValidationRules() {
    return [
      body("title")
        .trim()
        .isString()
