export const SERVICES = [
    {
        ...
        detail: "A practical reset for ants, roaches, spiders, and the small signs you should not ignore.",
        type: "Residential",
        icon: "bug",
        price: "From $89",
    },
    {
        ...
        detail: "Careful inspection, targeted treatment, and a clear follow-up plan for peace of mind.",
        type: "Residential",
        icon: "shield",
        price: "From $249",
    },
    {
        ...
        name: "Rodent control",
        slug: "rodent-control",
        detail: "Find the entry points, remove the risk, and keep your home protected after we leave.",
        type: "Residential",
        icon: "house",
        price: "From $139",
    },
    ...
    },
    {
        ...
        name: "Deep cleaning",
        slug: "deep-cleaning",
        detail: "A detailed top-to-bottom clean for the places everyday routines miss.",
        type: "Residential",
        icon: "spray",
        price: "From $180",
    },
    {
        ...
        detail: "Reliable recurring or one-off cleaning for the rooms you live in most.",
        type: "Residential",
        icon: "droplets",
        price: "From $110",
    },
    {
        ...
        detail: "Professional cleaning for productive, welcoming workspaces and shared areas.",
        type: "Commercial",
        icon: "building",
        price: "From $220",
    },
    {
        ...
        detail: "Start fresh or hand over the keys with a space that is ready for what is next.",
        type: "Residential",
        icon: "clipboard",
        price: "From $210",
    },
...
export const SERVICE_IMAGES = {
    "general-pest": "https://images.unsplash.com/photo-1581578731548-c64695cc6952?auto=format&fit=crop&w=900&q=80",
    "bed-bug": "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=900&q=80",
    rodent: "https://images.unsplash.com/photo-1581578731548-c64695cc6952?auto=format&fit=crop&w=900&q=80",
    mosquito: "https://images.unsplash.com/photo-1581578731548-c64695cc6952?auto=format&fit=crop&w=900&q=80",
    "deep-clean": "https://images.unsplash.com/photo-1581578731548-c64695cc6952?auto=format&fit=crop&w=900&q=80",
    "home-clean": "https://images.unsplash.com/photo-1524758631624-e2822e304c36?auto=format&fit=crop&w=900&q=80",
    "office-clean": "https://images.unsplash.com/photo-1497366754035-f200968a6e72?auto=format&fit=crop&w=900&q=80",
    "move-clean": "https://images.unsplash.com/photo-1484154218962-a197022b5858?auto=format&fit=crop&w=900&q=80",
};
export const SERVICE_DETAILS = {
    "general-pest": {
        audience: "Homes, apartments, and small businesses with everyday pest activity.",
        included: [
    ...
    "bed-bug": {
        audience: "Households, hospitality spaces, and property teams dealing with bites, spotting, or confirmed activity.",
        included: [
    ...
    rodent: {
        audience: "Homes, restaurants, offices, and facilities with signs of rodents or unwanted entry.",
        included: [
    ...
    mosquito: {
        audience: "Homes, patios, event spaces, and outdoor areas that need seasonal relief.",
        included: [
    ...
    "deep-clean": {
        audience: "Homes, offices, and spaces that need a detailed reset beyond routine upkeep.",
        included: [
    ...
    "home-clean": {
        audience: "Busy households looking for a reliable one-time or recurring home clean.",
        included: [
    ...
    "move-clean": {
        audience: "Tenants, homeowners, landlords, and property teams between occupants.",
        included: [
